...
export default function Home() {
  ...
  const handleFileUpload = async (file: File) => {
    ...
    if (!file.name.endsWith('.tar') && file.type !== 'application/x-tar') {
      setUploadStatus({
        status: 'error',
        message: 'الملف يجب أن يكون بصيغة .tar',
        progress: 0
      })
      return
    }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex flex-col">
        ...
        <div className="w-full max-w-4xl space-y-6">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-slate-400 text-lg">
              قم برفع ملف .tar لاستخراج وتشغيل ملفات النظام
            </p>
          </div>
          ...
          <Card className="bg-slate-800/50 border-slate-700 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription className="text-slate-400">
                اسحب وأفلت ملف .tar أو انقر لاختيار الملف
              </CardDescription>
            </CardHeader>
                ...
                <div className="flex flex-col items-center gap-4 text-center">
                  ...
                  <div>
                    <p className="text-lg font-medium text-white">
                      {isDragging ? 'أفلت الملف هنا' : 'اسحب ملف .tar هنا'}
                    </p>
            ...
            <CardContent className="pt-6">
              <div className="grid md:grid-cols-4 gap-4 text-center">
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-slate-500">اختر ملف .tar</p>
                </div>
                <div className="space-y-2">
                  <div className="w-10 h-10 rounded-full bg-emerald-400/20 flex items-center justify-center mx-auto">
      ...
      <footer className="mt-auto py-4 text-center text-slate-500 text-sm border-t border-slate-800">
        <p>مستورد ملفات النظام - استخراج وتشغيل ملفات .tar</p>
      </footer>
